...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
	try {
		...
		let nais = (m.isGroup && !chat.nsfw) ? 'https://raw.githubusercontent.com/clicknetcafe/json-db/main/avalonbot/media/picbot/nsfw/nsfwoff.jpg' : `https://raw.githubusercontent.com/clicknetcafe/json-db/main/avalonbot/media/picbot/nsfw/nsfw_${meh}.jpg`
