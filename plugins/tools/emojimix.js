...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	const res = await fetch(`https://tenor.googleapis.com/v2/featured?key=${db.data.datas.gapiskey}&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(l)}_${encodeURIComponent(r)}`)
